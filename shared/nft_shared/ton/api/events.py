...
from nft_shared.ton.config import TON_API_BASE_URL
from nft_shared.ton.session import get_ton_headers
  ...
  "actions": [
    {
      ...
      "NftItemTransfer": {
        ...
        "config": "0:fce655f4a237d5167954b3271df4db5fc4e4a384df4e1f5cc7e12c9b59f4b585",

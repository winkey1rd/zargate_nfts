...
class OpeningORM(Base):
    ...
    box_address: Mapped[str] = mapped_column(String(48), ForeignKey('nfts.address'), nullable=False, index=True)
    ...
    open_wallet_address: Mapped[str] = mapped_column(String(48), nullable=False, index=True)
